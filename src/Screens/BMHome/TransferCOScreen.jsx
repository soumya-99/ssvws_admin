		...
		<div>
			...
			>
				<main className="px-4 h-auto my-10 mx-32">
					...
					// // setVisible(true)
					// }}
					// onClick={() => navigate("/homebm/trancefercofrom")}
					// onClick={() => {
					// 	navigate(`/homebm/trancefercofrom/`, {
					// 	  state: { approval_status: "N" }, // Only sending approval_status
					// 	});
					//   }}
					...
					<TranceferCOPending
						...
						loanAppData={loanApplications}
						radioType={radioType}
						title="Pending Trancefer CO List"
						setSearch={(data) => setSearch(data)}
