		...
		<div className="p-8 space-y-6 bg-slate-50 min-h-screen rounded-3xl">
						...
						>
							<div className="w-full max-h-[150px] overflow-auto">
								{/* <p className="text-center text-slate-700">
									Here you can add more stats or links—for example,
									<br />
									<strong>Last login:</strong> 10 May 2025
								</p> */}
								<ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
									{dummyUserList?.map((user, i) => (
										<>
											...
											<hr className="border-t border-purple-300 my-2 w-3/4" />
										</>
									))}
								</ul>
							</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-6 gap-6">
				<div className="col-span-1 md:col-span-2 bg-white rounded-2xl shadow-md p-6">
					<h2 className="text-xl font-medium text-slate-700">Loan Disbursed</h2>
					<div className="grid grid-cols-2 gap-4 mt-4 text-slate-700">
						<div>
							<p className="text-sm">This Month</p>
							<p className="text-2xl font-bold text-pink-600">1,920</p>
						</div>
						<div>
							<p className="text-sm">No. of Groups</p>
							<p className="text-2xl font-semibold text-slate-700">35</p>
						</div>
						<div>
							<p className="text-sm">Today</p>
							<p className="text-2xl font-bold text-pink-600">22</p>
						</div>
						<div>
							<p className="text-sm">No. of Groups</p>
							<p className="text-2xl font-semibold text-slate-700">50</p>
						</div>
					</div>
				</div>
				...
				<div className="col-span-1 md:col-span-2 bg-white rounded-2xl shadow-md p-6">
					...
					<div className="grid grid-cols-2 gap-4 mt-4 text-slate-800">
						<div>
							<p className="text-sm">This Month</p>
						...
						<div>
							<p className="text-sm">No. of Groups</p>
							<p className="text-2xl font-semibold text-slate-700">28</p>
						</div>
						<div>
							<p className="text-sm">Today</p>
